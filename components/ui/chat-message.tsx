...
const chatBubbleVariants = cva("group/message relative break-words rounded-lg p-3 text-sm", {
  variants: {
    isUser: {
      true: "sm:max-w-[70%] bg-primary text-primary-foreground",
      false: "w-full bg-transparent text-foreground",
    },
    animation: {
      none: "",
